...
export function PhysicalSpecialtiesComplexFunc(props: any) {
    ...
    return (
        <div className="PhysicalSpecialtiesStatHolder">
            ...
            <div className="PhysicalBothRows">
                ...
                <div className="PhysicalSecondRow">
                    <div className="singleSpecHolder">
...
export const PhysicalSpecialtiesCompex = React.memo(PhysicalSpecialtiesComplexFunc);